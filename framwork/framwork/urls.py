...
urlpatterns = [
    ...
    url(r'^drf/article/$', views.DrfArticleView.as_view()),
    url(r'^drf/article/(?P<pk>\d+)/$', views.DrfArticleView.as_view()),
    ...
    url(r'^page/article/(?P<pk>\d+)/$', views.PageArticleView.as_view()),
]
