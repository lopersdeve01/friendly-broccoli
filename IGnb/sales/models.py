...
class Customer(models.Model):
    ...
    class_list = models.ManyToManyField('ClassList', verbose_name="已报班级",blank=True,)  #24qi

    # 成单日期，统计成单日期的时候会用到
    deal_date = models.DateField(null=True,blank=True)
    # course_record - - py24qi()   customer.filter(class_list=24qi)
...
class StudyRecord(models.Model):
    ...
    # models.StudyRecord.objects.create(homework_note='xx',course_record=course_record_obj(72),student_id=1)
    # models.StudyRecord.objects.create(homework_note='xx',course_record=course_record_obj(72),student_id=2)
    # models.StudyRecord.objects.create(homework_note='xx',course_record=course_record_obj(72),student_id=3)
    class Meta:
